/**
 * @fileoverview Main entry point for Cart Service
...
async function bootstrap() {
  ...
  try {
    ...
    const config = new DocumentBuilder()
      .setTitle('TechPotli Cart Service API')
      .setDescription('Shopping cart management service for TechPotli e-commerce platform')
      .setVersion('1.0')
    ...
    logger.log(`🚀 Cart Service is running on: http://${host}:${port}`);
